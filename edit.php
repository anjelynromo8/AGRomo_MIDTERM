...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Update data record
    $sql = "UPDATE members SET name='$name', gender='$gender', email='$email', address='$address', religion='$religion' WHERE id='$id'";
    ...
    <hr"mt-4">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (empty($input_religion)) {
                $tin_err = "Please enter your Religion.";
            } else {
                $tin = $input_religion;
            }

            // Check input errors before inserting in database
            if (empty($name_err) && empty($gender_err) && empty($email_err) && empty($address_err) && empty($religion_err)) {
                // Prepare an update statement
                $sql = "UPDATE members SET name=?, gender=?, email=?, address=?, religion=? WHERE id=?";

                if ($stmt = mysqli_prepare($link, $sql)) {
                    // Bind variables to the prepared statement as parameters
                    mysqli_stmt_bind_param($stmt, "sssssi", $param_name, $param_gender, $param_email, $param_address, $param_religion, $param_id);
                            ...
                            <div>
                                <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post">
                                    ...
                                    <div>
                                        ...
                                        <input type="religion" id="religion" name="religion" value="<?php echo $religion; ?>" required>
                                    </div>
